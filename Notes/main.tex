...
\end{Verbatim}
        \item \textbf{Create separate boot Partition (because of LUKS):}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{cfdisk>} \textcolor{command}{n}
\textcolor{root}{cfdisk>} \textcolor{command}{512MiB}
\end{Verbatim}
...
\end{Verbatim}
        ...
        \item \textbf{Create EXT4 for boot:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{root#} \textcolor{command}{mkfs.ext4} [-L "BOOT_GRUB"] <\textcolor{block}{/dev/sdX2}>
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{root#} \textcolor{command}{cryptsetup} [--label "LUKS"] luksFormat <\textcolor{block}{/dev/sdX3}>
> YES
> <PASSWORD>
> <PASSWORD (VERIFY)>
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{root#} \textcolor{command}{cryptsetup} open --type luks <\textcolor{block}{/dev/sdX3}> <luks_root>
> <PASSWORD>
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{root#} \textcolor{command}{mount} <\textcolor{block}{/dev/sdX2}> <\textcolor{dir}{/mnt/boot/}>
\end{Verbatim}

    \item \textbf{Create EFI dir:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{root#} \textcolor{command}{mkdir} <\textcolor{dir}{/mnt/boot/efi/}>
\end{Verbatim}
    \item \textbf{Mount EFI partition:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{root#} \textcolor{command}{mount} <\textcolor{block}{/dev/sdX1}> <\textcolor{dir}{/mnt/boot/efi/}>
\end{Verbatim}
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{[root#]} [\textcolor{command}{yes} |] \textcolor{command}{pacman} -S efibootmgr grub [os-prober mtools]
\end{Verbatim}
...
--efi-directory=<\textcolor{dir}{/boot/efi/}> --bootloader-id=GRUB_UEFI
\end{Verbatim}

    \item \textbf{Find UUID of encrypted root fs:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{[root#]} \textcolor{command}{blkid} | \textcolor{command}{grep} "<cryptsetup>"
\end{Verbatim}    

    \item \textbf{Edit GRUB config for encryption:}
\newline File (\textbf{\textcolor{file}{/etc/default/grub}}):
\begin{Verbatim}[commandchars=\\\{\}]
GRUB_CMDLINE_LINUX="cryptdevice=UUID=<UUID>:<cryptroot> \char92 
...
\textcolor{root}{[root#]} \textcolor{command}{grub-mkconfig} -o \textcolor{file}{/boot/efi/EFI/GRUB_UEFI/grub.cfg}
\end{Verbatim}
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{Verbatim}[commandchars=\\\{\}]
\underline{\href{https://linuxlink.timesys.com/docs/engineering/wiki/HOWTO_Install_GRUB2_with_EFI_support}{https://linuxlink.timesys.com/docs/engineering/wiki/HOWTO_Install_GRUB2_with_EFI_support}}
\underline{\href{https://www.tecmint.com/arch-linux-installation-and-configuration-guide/}{https://www.tecmint.com/arch-linux-installation-and-configuration-guide/}}
\end{Verbatim}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Installation %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Easy Installation}
\begin{Verbatim}[commandchars=\\\{\}]
PARTITIONING:
cfdisk:
gpt
