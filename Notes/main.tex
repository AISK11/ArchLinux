...
\end{Verbatim}
    ...
    \item \textbf{Set Unit Size:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(parted)} \textcolor{command}{unit} <mib>
\end{Verbatim}
...
\textcolor{root}{(parted)} \textcolor{command}{(p)rint} free 
\end{Verbatim}        
        \item \textbf{Partition - EFI (>= 300MB:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(parted)} \textcolor{command}{mkpart} primary 0 512
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{(parted)} \textcolor{command}{mkpart} primary 512 100\%
...
\newline \underline{\href{https://wiki.archlinux.org/title/Syslinux}{https://wiki.archlinux.org/title/Syslinux}}
