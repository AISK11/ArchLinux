...
\begin{Verbatim}[commandchars=\\\{\}]
...
UUID=<UUID> <MOUNT_POINT> <ext4> <rw,relatime>\textcolor{command}{,noatime,commit=60} <0> <1>
...
\end{Verbatim}
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{user}{user\$} \textcolor{command}{git} clone <\underline{\href{https://aur.archlinux.org/coredns.git}{https://aur.archlinux.org/coredns.git}}>
\end{Verbatim}
    \item \textbf{Go to cloned directory:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{user}{user\$} \textcolor{command}{cd} <\textcolor{dir}{./coredns/}>
\end{Verbatim}
...
\textcolor{comment}{## dhcpcd-<version>:<os>:<machine>:<platform> e.g. dhcpcd-5.5.6:NetBSD-6.99.5:i386:i386}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{DNS}
\underline{\href{https://dns.sb/doh/}{https://dns.sb/doh/}}
