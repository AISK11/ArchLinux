...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{GRUB}
\underline{\href{https://github.com/torvalds/linux/blob/master/Documentation/admin-guide/kernel-parameters.txt}{Linux kernel parameters}}
\section{Configuration}
\begin{enumerate}
    \item \textbf{Basic GRUB settings:}
\newline File (\textbf{\textcolor{file}{/etc/default/grub}}):
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{comment}{## Do not rename network interfaces and preserve}
...
\textcolor{comment}{## Default GRUB Linux parameters:}
GRUB_CMDLINE_LINUX_DEFAULT="loglevel=3 quiet"

\textcolor{comment}{## Encrypted GRUB on /boot/:}
GRUB_CMDLINE_LINUX="cryptdevice=UUID=<UUID>:<luks_lvm> \char92 
root=</dev/vg0/root> cryptkey=rootfs:/root/.luks/key"
\textcolor{comment}{## Enable encrypted GRUB:}
GRUB_ENABLE_CRYPTODISK=y
