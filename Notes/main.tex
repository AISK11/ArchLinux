...
\end{Verbatim}
        ...
        \item \textbf{Encrypted root filesystem:}
        \begin{enumerate}
...
> <PASSWORD>
\end{Verbatim}
        \item \textbf{Create Root filesystem:}
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{root#} \textcolor{command}{mkfs.ext4} [-L "root"] <\textcolor{block}{/dev/mapper/luks_root}>
\end{Verbatim}      
        \end{enumerate}
    \end{enumerate}
...
\begin{Verbatim}[commandchars=\\\{\}]
\textcolor{root}{root#} \textcolor{command}{mkdir} -p <\textcolor{dir}{/mnt/boot/EFI/}>
\end{Verbatim}
...
--efi-directory=<\textcolor{dir}{/efi/}> --bootloader-id=GRUB_UEFI
\end{Verbatim}
